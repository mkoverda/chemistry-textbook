...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        >{\hsize=1\hsize}Z
        >{\hsize=1\hsize}Z
        >{\columncolor{palette_green_8}\hsize=1\hsize}Z
        >{\hsize=1\hsize}Z
        >{\hsize=1\hsize}Z
        >{\hsize=1\hsize}Z
        >{\hsize=1\hsize}Z
        ...
        \hline
        &  &  & \cellcolor{palette_yellow_9}$-1$ & H & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  & \\
        &  &  &  & He &  &  &  &  &  &  &  & \\
        &  &  &  & Li & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  & \\
        &  &  &  & Be &  & \cellcolor{palette_yellow_9}$+2$  &  &  &  &  &  & \\
        &  &  &  & B &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  & \\
        \cellcolor{palette_yellow_9}$-4$ & $-3$ & $-2$ & $-1$ & C & $+1$ & \cellcolor{palette_yellow_9}$+2$ & $+3$ & \cellcolor{palette_yellow_9}$+4$ &  &  &  & \\
        & \cellcolor{palette_yellow_9}$-3$ & $-2$ & $-1$ & N & $+1$ & $+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & \cellcolor{palette_yellow_9}$+5$ &  &  & \\
        &  & \cellcolor{palette_yellow_9}$-2$ & $-1$ & O & $+1$ & $+2$ &  &  &  &  &  & \\
        &  &  & \cellcolor{palette_yellow_9}$-1$ & F &  &  &  &  &  &  &  & \\
        &  &  &  & Ne &  &  &  &  &  &  &  & \\
        &  &  & $-1$ & Na & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  & \\
        &  &  &  & Mg &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  & \\
        &  &  &  & Al & $+1$ &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  & \\
        \cellcolor{palette_yellow_9}$-4$ & $-3$ & $-2$ & $-1$ & Si & $+1$ & $+2$ & $+3$ & \cellcolor{palette_yellow_9}$+4$ &  &  &  & \\
        & \cellcolor{palette_yellow_9}$-3$ & $-2$ & $-1$ & P & $+1$ & $+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & \cellcolor{palette_yellow_9}$+5$ &  &  & \\
        &  & \cellcolor{palette_yellow_9}$-2$ & $-1$ & S & $+1$ & $+2$ & $+3$ & \cellcolor{palette_yellow_9}$+4$ & $+5$ & \cellcolor{palette_yellow_9}$+6$ &  & \\
        &  &  & \cellcolor{palette_yellow_9}$-1$ & Cl & \cellcolor{palette_yellow_9}$+1$ & $+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & \cellcolor{palette_yellow_9}$+5$ & $+6$ & \cellcolor{palette_yellow_9}$+7$ & \\
        &  &  &  & Ar &  &  &  &  &  &  &  & \\
        &  &  &  & K & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  & \\
        &  &  &  & Ca &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  & \\
        &  &  &  & Sc & $+1$ & $+2$ & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  & \\
        &  &  &  & Ti &  & $+2$ & $+3$ & \cellcolor{palette_yellow_9}$+4$ &  &  &  & \\
        &  &  &  & V & $+1$ & $+2$ & $+3$ & $+4$ & \cellcolor{palette_yellow_9}$+5$ &  &  & \\
        &  & $-2$ & $-1$ & Cr & $+1$ & $+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & $+5$ & \cellcolor{palette_yellow_9}$+6$ &  & \\
        & $-3$ & $-2$ & $-1$ & Mn & $+1$ & \cellcolor{palette_yellow_9}$+2$ & $+3$ & \cellcolor{palette_yellow_9}$+4$ & $+5$ & $+6$ & \cellcolor{palette_yellow_9}$+7$ & \\
        &  & $-2$ & $-1$ & Fe & $+1$ & \cellcolor{palette_yellow_9}$+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & $+5$ & $+6$ &  & \\
        &  &  & $-1$ & Co & $+1$ & \cellcolor{palette_yellow_9}$+2$ & \cellcolor{palette_yellow_9}$+3$ & $+4$ & $+5$ &  &  & \\
        &  &  & $-1$ & Ni & $+1$ & \cellcolor{palette_yellow_9}$+2$ & $+3$ & $+4$ &  &  &  & \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        \hline
        &  &  &  & Cu & $+1$ & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & Zn &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & Ga &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        $-4$ &  &  &  & Ge &  & $+2$ &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        & \cellcolor{palette_yellow_9}$-3$ &  &  & As &  &  & \cellcolor{palette_yellow_9}$+3$ &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  & \cellcolor{palette_yellow_9}$-2$ &  & Se &  & $+2$ &  & \cellcolor{palette_yellow_9}$+4$ &  & \cellcolor{palette_yellow_9}$+6$ &  &  \\
        &  &  & \cellcolor{palette_yellow_9}$-1$ & Br & \cellcolor{palette_yellow_9}$+1$ &  & \cellcolor{palette_yellow_9}$+3$ &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  &  &  & Kr &  & $+2$ &  &  &  &  &  &  \\
        &  &  &  & Rb & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  &  \\
        &  &  &  & Sr &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & Y &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Zr &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        &  &  &  & Nb &  &  &  &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  &  &  & Mo &  &  &  &  &  & \cellcolor{palette_yellow_9}$+6$ &  &  \\
        &  &  &  & Tc &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  & \cellcolor{palette_yellow_9}$+7$ &  \\
        &  &  &  & Ru &  &  & $+3$ & \cellcolor{palette_yellow_9}$+4$ &  &  &  & \cellcolor{palette_yellow_9}$+8$ \\
        &  &  &  & Rh &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Pd &  & \cellcolor{palette_yellow_9}$+2$ &  & $+4$ &  &  &  &  \\
        &  &  &  & Ag & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  &  \\
        &  &  &  & Cd &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & In &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        $-4$ &  &  &  & Sn &  & \cellcolor{palette_yellow_9}$+2$ &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        & $-3$ &  &  & Sb &  &  & \cellcolor{palette_yellow_9}$+3$ &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  & $-2$ &  & Te &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  & \cellcolor{palette_yellow_9}$+6$ &  &  \\
        &  &  & \cellcolor{palette_yellow_9}$-1$ & I & $+1$ &  &  &  & \cellcolor{palette_yellow_9}$+5$ &  & $+7$ &  \\
        &  &  &  & Xe &  & $+2$ &  & $+4$ &  & $+6$ &  & $+8$ \\
        &  &  &  & Cs & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  &  \\
        &  &  &  & Ba &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & La &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Ce &  &  & \cellcolor{palette_yellow_9}$+3$ & $+4$ &  &  &  &  \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        \hline
        &  &  &  & Pr &  &  & \cellcolor{palette_yellow_9}$+3$ & $+4$ &  &  &  &  \\
        &  &  &  & Nd &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Pm &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Sm &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Eu &  & $+2$ & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Gd &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Tb &  &  & \cellcolor{palette_yellow_9}$+3$ & $+4$ &  &  &  &  \\
        &  &  &  & Dy &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Ho &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Er &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Tm &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Yb &  & $+2$ & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Lu &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Hf &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        &  &  &  & Ta &  &  &  &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  &  &  & W &  &  &  &  &  & \cellcolor{palette_yellow_9}$+6$ &  &  \\
        &  &  &  & Re &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  & \cellcolor{palette_yellow_9}$+7$ &  \\
        &  &  &  & Os &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  & \cellcolor{palette_yellow_9}$+8$ \\
        &  &  &  & Ir* &  &  & \cellcolor{palette_yellow_9}$+3$ & $+4$ &  &  &  &  \\
        &  &  &  & Pt &  & \cellcolor{palette_yellow_9}$+2$ &  & \cellcolor{palette_yellow_9}$+4$ &  & $+6$ &  &  \\
        &  &  &  & Au & $+1$ &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Hg & $+1$ & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        &  &  &  & Tl & \cellcolor{palette_yellow_9}$+1$ &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Pb &  & \cellcolor{palette_yellow_9}$+2$ &  & $+4$ &  &  &  &  \\
        &  &  &  & Bi &  &  & \cellcolor{palette_yellow_9}$+3$ &  & $+5$ &  &  &  \\
        &  &  &  & Po &  & $+2$ &  & $+4$ &  &  &  &  \\
        &  &  & $-1$ & At & $+1$ &  & $+3$ &  & $+5$ &  & $+7$ &  \\
        &  &  &  & Rn &  & $+2$ &  &  &  &  &  &  \\
        &  &  &  & Fr & \cellcolor{palette_yellow_9}$+1$ &  &  &  &  &  &  &  \\
        &  &  &  & Ra &  & \cellcolor{palette_yellow_9}$+2$ &  &  &  &  &  &  \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        \hline
        &  &  &  & Ac &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Th &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        &  &  &  & Pa &  &  &  &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  &  &  & U &  &  &  & $+4$ &  & \cellcolor{palette_yellow_9}$+6$ &  &  \\
        &  &  &  & Np &  &  &  &  & \cellcolor{palette_yellow_9}$+5$ &  &  &  \\
        &  &  &  & Pu &  &  &  & \cellcolor{palette_yellow_9}$+4$ &  &  &  &  \\
        &  &  &  & Am &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Cm &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Bk &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Cf &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Es &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Fm &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Md &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & No &  & $+2$ &  &  &  &  &  &  \\
        &  &  &  & Lr &  &  & \cellcolor{palette_yellow_9}$+3$ &  &  &  &  &  \\
        &  &  &  & Rf &  &  &  & $+4$ &  &  &  &  \\
        &  &  &  & Db &  &  &  &  & $+5$ &  &  &  \\
        &  &  &  & Sg &  &  &  &  &  & $+6$ &  &  \\
        &  &  &  & Bh &  &  &  &  &  &  & $+7$ &  \\
