...
\definecolor{palette_green_8}{HTML}{C4E2C5} % «Зелёный 8» из палитры (COLORS.md)
\definecolor{palette_yellow_9}{HTML}{FBF2BA} % «Жёлтый 9» из палитры (COLORS.md)
\definecolor{palette_blue_9}{HTML}{E9F1FD} % «Синий 9» из палитры (COLORS.md)
\definecolor{palette_purple_9}{HTML}{F7ECF8} % «Пурпурный 9» из палитры (COLORS.md)
